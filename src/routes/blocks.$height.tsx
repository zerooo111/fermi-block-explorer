			...
			<div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-7xl">
				...
				<div className="mb-6 sm:mb-8">
					...
					<div className="flex items-start justify-between">
						<div>
							<h1 className="text-3xl sm:text-4xl font-bold font-mono tabular-nums mb-2">
				...
				<div className="border">
					...
					<div className="border-t p-4 sm:p-6">
						...
						<div className="flex items-start justify-between gap-4">
							<p className="font-mono text-neutral-500 text-xs sm:text-sm break-all flex-1">
								{stateRootHex}
							</p>
							<button
								type="button"
					...
					{data.block.batch_summaries.length > 0 && (
						<div className="border-t">
							<div className="px-4 sm:px-6 py-3 sm:py-4 bg-muted border-b">
											...
											>
												<td className="py-3 sm:py-4 px-3 sm:px-6">
													<Link
														to="/transactions/$id"
														params={{ id: tx.id }}
														className="font-mono text-xs sm:text-sm text-primary hover:underline inline-flex items-center gap-2 group/link"
													>
														{tx.id}
												...
												<td className="py-3 sm:py-4 px-3 sm:px-6">
													<span className="font-medium text-sm">{tx.side}</span>
												</td>
								...
								<table className="w-full">
									...
									<tbody>
										{data.events.map((event) => (
											...
											>
												<td className="py-3 sm:py-4 px-3 sm:px-6">
													<span className="font-mono text-xs sm:text-sm">{event.id}</span>
												</td>
												<td className="py-3 sm:py-4 px-3 sm:px-6">
													<span className="font-mono text-xs sm:text-sm text-muted-foreground">
